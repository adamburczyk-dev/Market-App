...
Used for both signal.generated (strategy's rule-based signals) and
macro.regime_changed (the market-wide regime bias). Poison-message safe:
malformed payloads are terminated; transient failures are NAK'd and redelivered
