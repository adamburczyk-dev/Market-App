...
Per the architecture rule: events for notifications, HTTP for queries. Backtest
pulls history on demand (request- or schedule-triggered), so a plain query client
is the right shape — no subscription.
"""
