...
| **D2** | Horyzont 10 / 21 / 63 | **ZAMKNIĘTA 2026-08-05** — wdrożona i przestawiona: `horizon=63`, `excess=True`, `pt_mult=1.0`, okna `test_size=189` / `holdout=252` / `val=126`. Potwierdzone na 414 symbolach: `horizontal_share` 0.6449 w paśmie, porządek 63 ≻ 21 ≻ 10 i nadwyżkowa ≻ absolutna na każdym poziomie | — |
